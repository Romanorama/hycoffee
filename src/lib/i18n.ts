...
export const ui = {
  de: {
    ...
    footer: {
      ...
      newsletterSuccess: 'Danke! Wir melden uns.',
      newsletterError: 'Anmeldung fehlgeschlagen. Bitte erneut versuchen.',
  ...
  en: {
    ...
    footer: {
      ...
      newsletterSuccess: 'Thanks! We will be in touch.',
      newsletterError: 'Sign-up failed. Please try again.',
      rights: 'All rights reserved.',
